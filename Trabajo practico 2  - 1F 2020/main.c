        ...
        case 1:
            ...
            if(emptySpace>=0)
            {
                ...
                do
                {
                    ...
                    validationName=getString(requestedName,"Ingrese el nombre empleado","Nombre invalido, cantidad de caracteres [min 2 - max 30]",2,51);
                ...
                if(validationName!=-1)
                {
                    ...
                    do
                    {
                        ...
                        validationLastName=getString(requestedLastName,"Ingrese el apellido del empleado","Apellido invalido, cantidad de caracteres [min 2 - max 50]",2,51);
